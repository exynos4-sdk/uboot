...
#define CONFIG_EXYNOS4412_ITOP	1  //BaseBoard(itop4412)
...
//#define CONFIG_SECURE_TZSW_ONLY  //dont use for secboot tzpc
#define CONFIG_SECURE_SMC
...
#define CONFIG_BOOTARGS \
	"console=ttySAC2,115200n8 androidboot.console=ttySAC2"\
	" ddr=3"
